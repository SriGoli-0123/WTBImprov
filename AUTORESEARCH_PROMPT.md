...
| | task | session |
|---|---|---|
| Original baseline | 352/1024 (34.4%) | 4/256 (1.6%) |
| Best recorded (`score_igar_v24`) | **404/1024 (39.5%)** | **12/256 (4.7%)** |

17 full runs have already been scored. `HEAD` currently carries an unscored
method called COG-FS (`wtb/model_handler/cogfs.py`).
